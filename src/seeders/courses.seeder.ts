...
const coursesData = [
  {
    ...
    description:
      'Pelajari cara membangun API backend yang scalable dan maintainable menggunakan NestJS, Prisma, dan PostgreSQL dari nol hingga production.',
    price: 299000,
    isFree: false,
  ...
  },
  {
    ...
    description:
      'Kuasai containerization dengan Docker dan otomasi deployment menggunakan GitHub Actions. Deploy aplikasi NestJS ke cloud dengan percaya diri.',
    price: 249000,
    isFree: false,
    previewYoutubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    status: 'PUBLISHED' as const,
  ...
  },
  {
    ...
    description:
      'Belajar mengolah data menggunakan Python, Pandas, NumPy, dan Matplotlib. Cocok untuk pemula yang ingin terjun ke dunia data.',
    price: 0,
    isFree: true,
    previewYoutubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    status: 'PUBLISHED' as const,
  ...
  },
  {
    ...
    description:
      'Pelajari algoritma ML klasik hingga deep learning. Implementasi langsung pada dataset nyata dan deploy model ke API.',
    price: 399000,
    isFree: false,
    previewYoutubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    status: 'PUBLISHED' as const,
  ...
  },
  {
    ...
    description:
      'Kuasai Flutter dari dasar hingga mahir. Buat aplikasi cross-platform yang indah dan performan untuk iOS dan Android.',
    price: 349000,
    isFree: false,
    previewYoutubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    status: 'PUBLISHED' as const,
  ...
  },
  {
    ...
    description:
      'Pelajari React Native dari nol. Gunakan keahlian JavaScript/React yang sudah kamu miliki untuk membangun aplikasi mobile native.',
    price: 0,
    isFree: true,
    previewYoutubeUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    status: 'PUBLISHED' as const,
