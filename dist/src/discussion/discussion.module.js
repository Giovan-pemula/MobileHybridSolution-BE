...
const discussion_repository_1 = require("./discussion.repository");
...
exports.DiscussionModule = DiscussionModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [discussion_service_1.DiscussionService, discussion_repository_1.DiscussionRepository],
    })
], DiscussionModule);
