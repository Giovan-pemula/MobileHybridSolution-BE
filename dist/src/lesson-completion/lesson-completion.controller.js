...
let LessonCompletionController = class LessonCompletionController {
    lessonCompletionService;
    constructor(lessonCompletionService) {
        this.lessonCompletionService = lessonCompletionService;
    }
    async toggleLessonCompletion(lessonId, user) {
    ...
    async getLearningAnalytics(user) {
...
//# sourceMappingURL=lesson-completion.controller.js.map